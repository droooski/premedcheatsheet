      ...
      <div className="container">
        ...
        <div className="bottom-resources">
          <div className="resource-card">
            ...
            <p className="resource-description">Polished, ATS-friendly CV template optimized specifically for medical school applications.</p>
            
            <div className="resource-actions">
              <button 
                className={`download-button ${downloadStatus['CV_Template_PremedCheatsheet.docx'] || 'ready'}`}
                onClick={() => handleDownload('CV_Template_PremedCheatsheet.docx', 'Professional CV Template')}
          ...
          <div className="resource-card">
            ...
            <p className="resource-description">Comprehensive database of summer programs, research opportunities, and their requirements.</p>
